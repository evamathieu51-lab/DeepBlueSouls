...
2. Put this mod into a file in luanti (you can create the file and name it "Mods")
3. Create a world in Luanti
4. Activate the mod in Luanti by selecting "Selecting mods"

## Autors
Eva Mathieu Kheddy Saint-Hilaire Emilia Sirbu
